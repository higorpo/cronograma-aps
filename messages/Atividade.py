mensagens_atividade = {
    'label_nome': 'Digite o nome da atividade*',
    'label_nome_disciplina': 'Selecione o nome da disciplina*',
    'label_grau': 'Selecione o grau de dificuldade',
    'label_prazo': 'Digite a data de prazo de entrega',
