...
class TelaDisciplina(AbstractTela):
    def __init__(self, controlador):
        ...
        super().__init__(controlador, nome_tela='Disciplinas')

    def init_components(self, data):
        headings = ['Código', 'Nome da disciplina', 'Período letivo']
        layout = super()\
            .layout_tela_lista(headings=headings, values=data, modulo_nome='disciplina', btn_visualizar_enabled=True)
