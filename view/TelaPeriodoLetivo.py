...
class TelaPeriodoLetivo(AbstractTela):
    def __init__(self, controlador):
        sg.ChangeLookAndFeel('Reddit')

        super().__init__(controlador, nome_tela='Períodos letivos')

    def init_components(self, data):
        headings = ['Código', 'Nome do período letivo']
        layout = super()\
            .layout_tela_lista(headings=headings, values=data, modulo_nome='período letivo', btn_visualizar_enabled=True)
